...
INSERT INTO Ventas (fecha_venta, total_venta, metodo_pago, monto_recibido, vuelto)
VALUES (NOW(), 2400, 'Efectivo', 2500, 100);

-- Ahora obtén el ID de la venta recién insertada:
SELECT LAST_INSERT_ID() AS venta_id;


INSERT INTO DetalleVentas (id_venta, id_producto, cantidad_vendida, precio_unitario_venta, subtotal)
VALUES (46, 1, 2, 1200, 2400);
