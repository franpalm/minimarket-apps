...
function Sidebar({ currentPage, onNavigate, modoPrueba }) {
      ...
      <div className="mt-auto px-6 py-4 relative">
        ...
        >
          ...
          <span className="font-semibold">
            Usuario: {modoPrueba ? 'Modo prueba' : 'Administrador'}
          </span>
        ...
        {dropdownOpen && (
            <ul className="absolute left-6 right-6 bottom-full mb-2 bg-gray-800 rounded shadow-lg py-2 z-50">
            ...
            <li>
              <button
                className="w-full text-left px-4 py-2 text-gray-100 hover:bg-blue-600 rounded"
                onClick={handleCerrarSesion}
              >
                {modoPrueba ? 'Salir del modo prueba' : 'Cerrar sesión'}
              </button>
            </li>
          </ul>
        )}
